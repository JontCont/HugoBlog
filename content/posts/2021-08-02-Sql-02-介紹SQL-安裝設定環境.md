...
date = '2021-08-02T22:45:32'
slug = 'Sql-02-介紹SQL-安裝設定環境'
description = ''
categories = ['資料庫技術', 'SQL']
tags = ['SQL']
keywords = ['SQL']
image = '/img/SQL/sql_server/bg.png'
+++
...
![](/img/SQL/sql_server/02.png)
![](/img/SQL/sql_server/03.png)

2. 到資料庫內有安全性的資料夾，開到有sa 選項按下右鍵(選擇屬性)。
![](/img/SQL/sql_server/04.png)

輸入密碼後，到狀態把登入選擇為啟用即可使用。
![](/img/SQL/sql_server/05.png)
