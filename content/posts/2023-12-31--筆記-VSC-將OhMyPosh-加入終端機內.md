+++
title = '【筆記】Powershell -  VSC 將 OhMyPosh 加入終端機內'
date = '2023-12-31T18:50:10'
slug = '-筆記-VSC-將OhMyPosh-加入終端機內'
url = '/2023/12/31/-筆記-VSC-將OhMyPosh-加入終端機內/'
description = ''
categories = ['筆記', '生活雜記']
tags = ['vsc', 'OhMyPosh', 'PowerShell']
keywords = []
image = '/image/20231223_18-48-56.png'
+++
