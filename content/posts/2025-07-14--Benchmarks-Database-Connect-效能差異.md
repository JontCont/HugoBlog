...
date = '2024-12-22T15:45:00'
slug = '-Benchmarks-Database-Connect-效能差異'
url = '/2025/07/14/-Benchmarks-Database-Connect-效能差異/'
description = '比較不同資料庫連線方式的效能差異，包括 DI 注入、直接建立 DbContext 以及使用連線池等方式'
categories = ['後端技術', 'C#']
tags = ['C#', '筆記', 'Benchmarks']
keywords = []
image = '/image/20250318_23-37-06.png'
+++
