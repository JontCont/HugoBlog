...
date = '2021-07-17'
slug = '-JS-定時器-timer-使用方式-setTimeout-VS-setInterval-'
url = '/2021/07/17/-JS-定時器-timer-使用方式-setTimeout-VS-setInterval-/'
description = ''
categories = ['前端技術', 'javascript']
tags = ['javascript']
keywords = ['ES6', 'timer', 'setTimeout', '定時器', 'setInterval']
image = '/img/Web/js/js-serialize/bg.png'
+++
