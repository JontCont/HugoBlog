...
date = '2021-07-28'
slug = '-JS-回呼函式-Callback-Function-'
url = '/2021/07/28/-JS-回呼函式-Callback-Function-/'
description = ''
categories = ['前端技術', 'javascript']
tags = ['js', 'Callback']
keywords = []
image = 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Callback-notitle.svg/740px-Callback-notitle.svg.png'
+++
